...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:joao\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5548991635455:+55 699373-3829\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD joao BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmao. Você não está registrado como amigo de joao. Registre-se para fazer amizade com o bot joao por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar joao|14\n\n──「 joao BOT 」──`,
			...
			const premium = ["5548991635455@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('554899165455@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO joao BOT * 」\n\`\`\``
					no = 0
...
// recursos anime, random @joao
          ...
          reply('Espere..')
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* joao\n*YOUTUBE:* https\n*WPP:* wa.me/+5548991635455\n*\n\nEspero que tenha gostado do bot️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
